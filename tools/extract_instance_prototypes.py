...
def main(model='vitl14', dataset='fs_coco17_support_novel_30shot', use_bbox='yes',
    ...
    # model = vit_large(patch_size=14, img_size=518, init_values=1.0,)
    # checkpoint = torch.load('/home/server/aaayanglib/NTIRE2025_CDFSOD-main/weights/dinov2_vitl14_pretrain.pth', map_location= 'cpu')
