...
_PREDEFINED_CD = [
    #("DIOR_train", "DIOR/train", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/DIOR/annotations/train.json"),
    #("DIOR_test", "DIOR/test", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/DIOR/annotations/test.json"),
    ("NWPUU_train", "NWPUU/train", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPUU/annotations/train.json"),
    ("NWPUU_test", "NWPUU/test", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPUU/annotations/test.json"),

    #("NWPU_train", "NWPU/train", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPU/annotations/train.json"),
    #("NWPU_test", "NWPU/test", "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPU/annotations/test.json"),
...
for shot in [1, 3, 5, 10, 20]:
    # new_anns = ("DIOR_{}shot".format(shot),
    #             "DIOR/train",
    #             "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/DIOR/annotations/{}_shot.json".format(shot))
    # _PREDEFINED_CD.append(new_anns)

    new_anns = ("NWPUU_{}shot".format(shot),
                "NWPUU/train",
                "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPUU/annotations/{}_shot.json".format(shot))
    _PREDEFINED_CD.append(new_anns)

    # new_anns = ("NWPU_{}shot".format(shot),
    #             "NWPU/train",
    #             "/home/server/aaayanglib/NTIRE2025_CDFSOD-main/datasets/NWPU/annotations/{}_shot.json".format(shot))
    # _PREDEFINED_CD.append(new_anns)
